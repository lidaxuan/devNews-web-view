 ...
 * @Description: 
 * @Author: 李大玄
 * @Date: 2022-09-24 16:30:59
 * @FilePath: /devNews-web-view/src/components/editor/index.tsx
 * @LastEditors: 李大玄
 * @LastEditTime: 2022-09-24 17:09:45
 */
...
const controls: string[] = ['undo', 'redo', 'separator', 'font-size', 'line-height',
  'letter-spacing', 'separator', 'text-color', 'bold', 'italic', 'underline', 'strike-through',
  'separator', 'superscript', 'subscript', 'remove-styles', 'emoji', 'separator', 'text-indent', 'text-align', 'separator', 'headings', 'list-ul',
  'list-ol', 'blockquote', 'code', 'separator', 'media', 'link', 'table', 'split', 'hr', 'separator', 'clear', 'separator', 'fullscreen'];
    ...
    const comp = {
      ...
      text: (
        <div className="dropdown-handler" data-title="图片上传">
          <Popover content={this.getImageUploadNode()} placement="bottom" trigger="click" open={this.state.imageUploadVisible} onOpenChange={this.onVisibleChange}>
            <FileImageOutlined />
          </Popover>
        </div>
      ),
